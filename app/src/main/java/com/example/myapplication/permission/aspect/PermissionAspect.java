package com.example.myapplication.permission.aspect;

import android.content.Context;

import androidx.fragment.app.Fragment;

import com.example.myapplication.permission.MyPermissionActivity;
import com.example.myapplication.permission.annotation.Permission;
import com.example.myapplication.permission.annotation.PermissionCancel;
import com.example.myapplication.permission.annotation.PermissionDenied;
import com.example.myapplication.permission.core.IPermission;
import com.example.myapplication.permission.util.PermissionUtils;
...
public class PermissionAspect {
    ...
    // 仅仅是只能找到这个函数
    @Pointcut
("execution(@com.example.myapplication.permission.annotation.Permission * *(..)) && @annotation(permission)") //  @Permission == permission
